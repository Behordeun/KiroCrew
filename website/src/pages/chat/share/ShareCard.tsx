...
/** The official Kiro ghost brand mark on a soft halo. KiroGhostMark paints
 *  the shipped brand asset as a CSS mask over currentColor (here the card's
 *  ink color), so the exported PNG carries the real logo, not an icon-library
 *  approximation. */
function GhostMark() {
  return (
    <div
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: '#cfc6ff', lineHeight: '16px' }}>{i18nT('pages.chat.share.card_tagline')}</div>
        </div>
      </div>
